...
<body>
	...
	<main class="main">
		<section class="section section-padding white-section contact" id="contact">
			<h2 class="section-heading">Kontakt do nas</h2>
			...
			<div class="wrapper">
				<form class="contact__form">
					...
					<textarea id="msg" cols="30" rows="5" class="contact__form-textarea"></textarea>
